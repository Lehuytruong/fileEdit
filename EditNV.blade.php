            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        <form action="{{url("nhan-vien/edit")}}" method="post">
                            @csrf
                            <input type="hidden" name="teacher_id" value="{{$teacher->teacher_id}}"/>
                            <div class="row">
                                <p class="text-warning col-lg-3" >Họ và tên</p>
                                <input type="text" class="col-lg-8" value="{{$teacher->teacher_name}}" name="teacher_name" placeholder="nhập tên">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="col-lg-8" value="{{$teacher->teacher_age}}" name="teacher_age" placeholder="nhập tuỏi">
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="col-lg-8" value="{{$teacher->teacher_gender}}" name="teacher_gender" placeholder="giới tính">
                            ...
                            <div class="row">
                                ...
                                <select name="lop_id" class="col-lg-8">
                                    ...
                                    @foreach($lops as $lop)
                                        <option @if($teacher->lop_id == $lop->lop_id)selected @endif value="{{$lop->lop_id}}">{{$lop->lop_name}}</option>
                                    @endforeach
                                </select>
